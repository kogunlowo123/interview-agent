"""Interview Agent - Main Agent Implementation."""
...
class InterviewAgentAgent:
    ...
    def __init__(self):
        ...
        self.interview_guide_generation_enabled = True
        self.question_bank_enabled = True
        self.feedback_evaluation_enabled = True
        self.consistency_detection_enabled = True
        self.hiring_summary_enabled = True
        self._tool_dispatch = {
            "generate_interview_guide": self.tools.generate_interview_guide,
            "create_question_bank": self.tools.create_question_bank,
            "evaluate_feedback": self.tools.evaluate_feedback,
            "detect_bias_signals": self.tools.detect_bias_signals,
            "generate_hiring_summary": self.tools.generate_hiring_summary,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['interview_guide_generation', 'question_bank', 'feedback_evaluation', 'consistency_detection', 'hiring_summary'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            "generate_interview_guide": ['generate', 'interview', 'guide'],
            "create_question_bank": ['create', 'question', 'bank'],
            "evaluate_feedback": ['evaluate', 'feedback'],
            "detect_bias_signals": ['detect', 'bias', 'signals'],
