"""Application configuration for Interview Agent."""
...
class Settings(BaseSettings):
    ...
    app_name: str = Field(default="interview-agent", description="Application name")
    ...
    opensearch_index: str = Field(default="interview_agent_vectors", description="Index")
    ...
    mcp_server_name: str = Field(default="interview-agent-mcp", description="MCP server name")

    a2a_discovery_url: str = Field(default="http://localhost:8500", description="A2A discovery URL")
    a2a_agent_id: str = Field(default="interview-agent", description="A2A agent ID")
